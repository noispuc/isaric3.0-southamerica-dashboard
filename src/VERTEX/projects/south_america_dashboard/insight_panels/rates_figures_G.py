...
def create_visuals(
    ...
    if dfs_casos:
        ...
        df_casos_all.rename(
            columns={"Severe dengue": "Confirmed cases rate"},
            inplace=True,
        )
    ...
    if dfs_hosp:
        ...
        fig_hosp, gid_hosp, glab_hosp, gabout_hosp = idw.fig_bar_chart(
            ...
            graph_about=(
                "Proportion of confirmed dengue cases (classi_fin 12) "
    ...
    if dfs_letal:
        ...
        fig_letal, gid_letal, glab_letal, gabout_letal = idw.fig_bar_chart(
            ...
            graph_about=(
                ...
                "divided by confirmed cases (classi_fin IN 12), by year."
            ),
        )
